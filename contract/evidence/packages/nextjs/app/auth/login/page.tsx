    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white rounded-lg shadow-md overflow-hidden">
        <div className="p-6 bg-gradient-to-br from-blue-600 to-indigo-700 text-white">
          <h2 className="text-2xl font-bold text-center" aria-label="区块链存证系统登录">
            区块链存证系统
          </h2>
          <p className="text-center mt-2 opacity-90">用户登录</p>
        </div>
        <div className="p-6">
          {error && <Alert message="登录失败" description={error} type="error" showIcon className="mb-4" closable />}
          ...
          >
            <Form.Item name="username" label="用户名" rules={[{ required: true, message: "请输入用户名" }]} hasFeedback>
              <Input
